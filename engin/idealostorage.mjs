  ...
  try {
    ...
    for (const info of listinfo) {
      try {
        ...
        await StorageVendorList.create(item);
        count++;
        if (count >= 3) {
          break;
        }
...
async function handleA(
  ...
  let existingProduct = await StorageList.findOne({
...
// };
const getlink = (str) => {
  if (str.toLowerCase().includes("0815"))return "https://www.0815.at/Smartphone-IT/Komponenten/Festplatten-SSDs";    
  ...
  if (str.toLowerCase().includes("arit"))return "https://www.arlt.com/Hardware/PC-Komponenten/Festplatten/";
  ...
  if(str.toLowerCase().includes("cw-mobile"))return "https://www.cw-mobile.de/catalogsearch/result/?q=hard+drive";
  if (str.toLowerCase().includes("cyberport"))return "https://www.cyberport.at/pc-und-zubehoer/festplatten-ssds.html";
  if (str.toLowerCase().includes("easy-"))return "https://www.easy-tecs.de/festplatten/";
  if (str.toLowerCase().includes("easynotebook"))return "https://www.easynotebooks.de/Zubehoer/Komponenten/FestplattenSSDs";
  if (str.toLowerCase().includes("ebay"))return "https://www.ebay.it/b/Hard-disk-interni/56083/bn_16546745";
  if (str.toLowerCase().includes("ejoker"))return "https://www.ejoker.de/elektronik-foto/computer-komponenten-zubehoer/komponenten-ersatzteile/interne-komponenten-hardware/interner-speicher/festplatten/";
  ...
  if (str.toLowerCase().includes("goldenprice"))return "https://www.goldenprice.it/informatica/componenti-assemblaggio/hard-disk";
  if (str.toLowerCase().includes("ldc"))return "https://www.ldc.it/140-memoria-ram";
  if (str.toLowerCase().includes("mindfactory"))return "https://www.mindfactory.de/search_result.php/search_query/hdd/Hardware/Festplatten+(HDD).html";
  if (str.toLowerCase().includes("miravia"))return "https://www.miravia.es/c/discos-duros-internos-103902/?src=pdp_breadcrumb";
  if (str.toLowerCase().includes("notebooksbilliger"))return "https://www.notebooksbilliger.de/produkte/hdd";
  ...
  if (str.toLowerCase().includes("pixmart"))return "https://www.pixmart.it/categoria-prodotto/componenti-pc/hdd-ssd/hdd-hdd-ssd/";
  if (str.toLowerCase().includes("proshop"))return "https://www.proshop.at/?s=HDD";
  if (str.toLowerCase().includes("ollo"))return "https://www.ollo.it/hard-disk/c_197";
  ...
  if (str.toLowerCase().includes("robertelectronic"))  return "https://robertelectronics.co.uk/collections/hard-disk";
  if (str.toLowerCase().includes("scan"))return "https://www.scan.co.uk/shop/computer-hardware/hard-drives-internal/all";
  if (str.toLowerCase().includes("senetic"))return "https://www.senetic.at/western_digital/hdd/";
  if (str.toLowerCase().includes("sferaufficio"))return "https://www.sferaufficio.com/categorie/dischi-rigidi-interni";
  if (str.toLowerCase().includes("siimsrl")) return "https://www.siimsrl.it/hdd.1.7.1105.sp.uw"; 
  ...
  if (str.toLowerCase().includes("store.ee")) return "https://store.ee.co.uk/category/components-and-storage,hard-drives/11026";
  ...
  if (str.toLowerCase().includes("techinn")) return "https://www.tradeinn.com/techinn/it/componenti-dischi-rigidi-hdd/15979/s";
  if (str.toLowerCase().includes("trippodo"))return "https://www.trippodo.com/it/764-componenti-pc-hardware?mot_q=hdd";
  ...
  if (str.toLowerCase().includes("xfilesaversa"))return "https://www.xfilesaversa.it/it/informatica/componentistica/internal-storage/";
  if (str.toLowerCase().includes("yeppon"))return "https://www.yeppon.it/c/videogames/componenti-gaming/ssd-gaming";
  return "https://www.amazon.it/s?i=computers&bbn=17492754031&rh=n%3A425916031%2Cn%3A460080031%2Cn%3A17492754031%2Cn%3A14076167031&dc&qid=1722140139&rnid=17492754031&ref=sr_nr_n_2&ds=v1%3AB%2BgYURv%2BXM%2BWG6cePSrEZ%2BaFxLiFdFQ84TjBVXtHr58";
};
async function saveToDatabase(drivers, mid, url) {
  try {
    ...
    await StorageNat.deleteMany({ storageid: mid });
    await StorageNat.create({
      storageid: mid,
      html: outerHTML
    });
  } catch (error) {
...
async function fetchStorage() {
  ...
  while (true) {
    ...
    const driver = await new Builder()
      ...
      .build();
    inn = 0;
    const url = `https://www.idealo.it/cat/3011I16-${
      count * pages
    }/hard-disk.html`;
    try {
  ...
  const csvFilePath = "outputstorage.csv";
