...
const getlink=(str)=>{
  if(str.toLowerCase().includes("amazon"))return "https://www.amazon.it/b/?ie=UTF8&node=460126031&pf_rd_p=e0a2c917-a1dd-4f87-a63e-d37c11434f01&pf_rd_r=E55XPXKWCPJYSV7QF279&pf_rd_s=pc-subnav-flyout-content-6&pf_rd_t=SubnavFlyout&ref_=sn_gfs_co_pc_460126031_3";
  if(str.toLowerCase().includes("bpm"))return  "https://www.bpm-power.com/it/online/componenti-pc/processori";
  if(str.toLowerCase().includes("eprice"))return  "https://www.eprice.it/catalogo/informatica/componenti-pc";
  if(str.toLowerCase().includes("redgaming"))return  "https://redgaming.it/3-cpu";
  ...
  if(str.toLowerCase().includes("sferaufficio"))return  "https://www.sferaufficio.com/offerte/pc-laptop-e-server";
  if(str.toLowerCase().includes("pixmart"))return  "https://www.pixmart.it/categoria-prodotto/componenti-pc/processori/";
  ...
  if(str.toLowerCase().includes("ebay"))return  "https://www.ebay.it/b/Processori-e-CPU-per-prodotti-informatici/164/bn_16546715";
