    ...
    while (true) {
      ...
      for (const element of priceElements) {
        try {
            ...
            await new Builder().forBrowser("chrome").build().get(href);
            const listinfo = await new Builder().forBrowser("chrome").build().findElements(By.className("product-offers-items-soop-4576-fallback"));
